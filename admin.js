...
async function loadAll(){try{await loadRentalLocations();await loadProducts();await loadReservations();await loadAdminSettings()}catch(e){show(e.message,true)}}
...
el('quickProduct').addEventListener('change',()=>fillLocationSelects(el('quickProduct').value,'quick'));initAdminSettings();
