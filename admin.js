...
async function loadAll(){try{await loadRentalLocations();await loadProducts();await loadReservations();await loadAdminSettings();await loadPartnerAdmin()}catch(e){show(e.message,true)}}
